      ...
      <div className="flex w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          ...
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Discover and explore upcoming tech conferences, summits, and events from around the world. Search by name, filter by technology tags, and sort by date or name.
          </p>
        </div>
